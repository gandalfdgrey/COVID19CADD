...
file_list = ["picks_drug_like.txt_23-06-22.txt", "picks_ghose.txt_23-06-22.txt", "picks_lipinski_relaxed.txt_23-06-22.txt", "picks_qed_mid.txt_23-06-22.txt", "picks_reos.txt_23-06-22.txt", "picks_veber.txt_23-06-22.txt"]
out = ["drug_like", "ghose", "lipinski", "qed_mid", "reos", "veber"]
out_f = ["usr_drg", "usr_ghs", "usr_lpn", "usr_qed", "usr_reos", "usr_vbr"]
...
sim_usr = (f"{sbd}/sim_usr_{out[choice-1]}.txt")  # results from the similarity search
sim_usr_top = (f"{sbd}/sim_usr_top_{out[choice-1]}.txt")  # top 15 results per active of the similarity search
sim_usrcat = (f"{sbd}/usrcat_{out[choice-1]}.txt")  # lowest energy conformer for each molecule
